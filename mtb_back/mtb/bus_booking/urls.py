...
from .views import UserRegistrationView ,AddBusView ,BookBusView ,CancelBookingView,DeleteBusView,LoginView,RegisterView,AdminView
...
urlpatterns = [
    ...
    path('admin/tasks/', AdminView.as_view(), name='admin_tasks'),
    path('api/register/', UserRegistrationView.as_view(), name='user-register'),
